...
class DailyWaterBalance(Base):
    ...
    temp_mean_c: Mapped[Optional[float]] = mapped_column(Float, nullable=True)
    ...
    solar_radiation_mj: Mapped[Optional[float]] = mapped_column(Float, nullable=True)
